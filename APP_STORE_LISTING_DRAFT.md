# Petpal — App Store listing (Phase 5 — paste into App Store Connect)

**Copyright:** 2026 Emilio Alecci  

Use this file while editing **Distribution** → **iOS** → your version (e.g. **1.0**) → **English (U.S.)** (or your primary locale). URLs must match **`APP_STORE_CONTACT_INFO.md`**.
...
1. **Distribution** (top) → **iOS** → select your **version** (e.g. Prepare for Submission).
2. Under **App Store** localization (**English (U.S.)**): **Name**, **Subtitle**, **Promotional Text**, **Description**, **Keywords**, **Support URL**, **Marketing URL**, **Copyright** (if shown on this page).
3. **Privacy Policy URL** may appear under **App Privacy** as well as listing — use the **same** `privacy.html` URL everywhere.
4. **Categories**: often under **App Information** (**General**) or the version sidebar — set **Primary** / **Secondary**.
5. **Save** after edits.
...
## URLs & contact (canonical)

See **`APP_STORE_CONTACT_INFO.md`**. Summary:

- **Privacy Policy URL:** `https://thyghos.github.io/petpal/privacy.html`
- **Support URL:** `https://thyghos.github.io/petpal/support.html`
- **Marketing URL:** `https://thyghos.github.io/petpal/terms.html` *(optional but recommended)*

Legacy single-page policy: https://thyghos.github.io/petpal-privacy/
...
Complete Apple’s questionnaire honestly → expect **4+** for this app (medical/educational framing may still be 4+; follow Connect’s questions).

---

## Screenshot plan (Phase 7)
