...
struct HomeTile: Identifiable, Hashable {
    ...
    static let allTiles: [HomeTile] = [
        HomeTile(id: "travel", icon: "airplane.departure", title: "Travel Mode", subtitle: "Find pet friendly places near you", gradient: ["BrandOrange", "BrandOrange"], iconSize: 24),
    ...
    /// Default home grid order (first = top). Emergency QR follows Travel for safety-on-the-go.
