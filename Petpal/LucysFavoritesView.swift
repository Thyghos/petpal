...
struct HelpfulProductsView: View {
    ...
    private static let lucyIntroFooter = "Lucy, the reason we created this app, is 14 and has been on the road full time for 5 years. These are companies and items she has used."

    private static let harvestHostsPromoLine = "Use code LUCY20 for 20% off."
    ...
    /// Pinned below the scrolling list so disclosure copy stays visible after partner links (see `AffiliateLinkDisclosure` in InsuranceCuratedContent.swift).
    private var affiliateDisclosureStickyFooter: some View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .safeAreaInset(edge: .bottom, spacing: 0) {
                affiliateDisclosureStickyFooter
            }
